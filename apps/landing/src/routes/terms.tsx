...
export const Route = createFileRoute("/terms")({
  head: () =>
    pageMeta(
      ...
      "Terms for the official Padu Relay and hosted Padu Hub services.",
      "/terms",
    ),
  component: Terms,
});
...
function Terms() {
  return (
    <LegalPage title="Terms of Service" lastUpdated="August 29, 2026">
      <p>
        These Terms govern the official services operated at padu.dev, relay.padu.dev, and
        hub.padu.dev. By using the official relay or hosted Hub, you agree to them. Our{" "}
      ...
      <section>
        ...
        <p>
          ...
          You give Padu only the permission needed to receive, transmit, store, and process that
      ...
      <section>
        ...
        <p>
          Stripe processes payments. Padu does not store complete payment-card details. Nothing in
      ...
      <section>
        ...
        <p>
          Padu can connect to services such as GitHub, Slack, Discord, Linear, Anthropic, and
          OpenAI. Those services have their own terms and privacy policies. Padu is not responsible
      ...
      <section>
        ...
        <p>
          ...
          without implied warranties. Padu is not liable for indirect or consequential losses
