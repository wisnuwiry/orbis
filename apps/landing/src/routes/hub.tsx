...
export const Route = createFileRoute("/hub")({
  head: () =>
    pageMeta(
      "Padu Hub - GitHub, Slack, and Discord triggers",
      "Run Padu Hub yourself and start agents on your own machines from GitHub, Slack, and Discord.",
      "/hub",
    ),
  component: Hub,
});
...
function Hub() {
  return (
    <SiteShell width="default">
      <h1 className="text-3xl font-medium tracking-tight mb-4">Padu Hub</h1>
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-4 pt-2">
        ...
        <a
          href="https://github.com/getpadu/hub"
          target="_blank"
    ...
    <figure className="space-y-3">
      <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02]">
        ...
        <div className="space-y-5 p-5">
          <DemoMessage author="developer" time="09:41">
            <p>
              <Mention /> show me the latest P0 issues
            </p>
          </DemoMessage>

          <DemoMessage author="padu-bot" time="09:41" bot>
          ...
          <DemoMessage author="developer" time="09:43">
            <p>
              <Mention /> create a pull request for the first one
            </p>
          </DemoMessage>

          <DemoMessage author="padu-bot" time="09:48" bot>
            <p>
...
function Mention() {
  return <span className="rounded bg-indigo-400/15 px-1 py-0.5 text-indigo-200">@padu-bot</span>;
}
  ...
  return (
    <div className="flex gap-3">
      <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border border-white/10 bg-white/[0.06]">
        {bot ? (
          <img src="/padu.svg" alt="" className="h-4 w-4" />
        ) : (
...
function Access() {
  return (
    <section className="space-y-6">
      ...
      <p className="text-white/70 leading-relaxed max-w-2xl">
        The hosted version is not generally available yet. Join the Padu Discord and watch the
        <span className="font-mono text-white/80"> #padu-hub</span> channel for the release
        announcement.
      </p>
    ...
    <section className="space-y-6">
      ...
      <div className="space-y-6">
        <FAQItem question="What is the Hub?">
          A separate service that sits above your Padu daemons. You connect one or more daemons to
          it and it gives them GitHub, Slack, and Discord triggers, with collaboration features
          planned. Padu works fully without it.
        </FAQItem>
        <FAQItem question="Why is it a separate service instead of part of the daemon?">
          <p>
            ...
            same RPCs the app and the CLI use, so anyone can build their own hub on top of Padu.
          </p>
          <p>
        ...
        <FAQItem question="Can I run it myself?">
          Yes. Run <code>npx @getpadu/hub</code> and complete setup in the browser. The source is
          available on{" "}
          <a href="https://github.com/getpadu/hub" className={LINK_CLASS}>
            GitHub
          </a>
          , and the{" "}
        ...
        <FAQItem question="What do I need to run it?">
          Node.js and a running Padu daemon. Hub guides you through connecting the provider apps
          you want.
        </FAQItem>
        <FAQItem question="Will there be a hosted version?">
          Yes. Join the Padu Discord and watch the <code>#padu-hub</code> channel. The hosted
        ...
        <FAQItem question="Do I have to move my team to a new tool?">
          ...
          already run. When the work gets serious you switch to the Padu app on those same daemons.
        </FAQItem>
        ...
        <FAQItem question="How do I get access?">
          ...
          and wait for the release announcement in <code>#padu-hub</code>. You do not need to
