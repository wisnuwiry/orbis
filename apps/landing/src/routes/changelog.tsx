...
export const Route = createFileRoute("/changelog")({
  head: () =>
    pageMeta(
      "Changelog - Padu",
      "Product updates, bug fixes, and improvements shipped in each Padu release. Track new agent providers, mobile features, and daemon changes over time.",
      "/changelog",
    ),
  component: Changelog,
});
...
function HeadingAnchor({ version }: { version: string }) {
  return (
    <a
      ...
      aria-label={`Link to Padu ${version}`}
    >
