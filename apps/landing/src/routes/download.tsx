...
export const Route = createFileRoute("/download")({
  ...
  head: () =>
    pageMeta(
      "Download Padu for macOS, Windows, Linux, iOS, and Android",
      "Install Padu on every platform. Native desktop apps for macOS, Windows, and Linux. Mobile apps for iOS and Android. Self-hosted, open source, free to download.",
      "/download",
    ),
  component: Download,
});
      ...
      <section className="rounded-xl border border-border bg-card/40 p-6 md:p-8">
        <div className="flex items-start justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Run the Padu server anywhere, connect from any client
            </p>
          </div>
