...
import { LetterTile, PaduTile } from "./atoms";
 ...
 * an optional running dot. Uses PaduTile so pinned and workspace icons match. */
function WorkspaceGlyph({ running, white }: { running?: boolean; white?: boolean }) {
  return (
    <span className="relative flex size-[18px] items-center justify-center">
      {white ? <span className="size-[18px] rounded-[5px] bg-mock-fg" /> : <PaduTile />}
      {running ? (
