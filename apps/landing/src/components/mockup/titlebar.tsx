...
const finderIconUrl = "/finder.png";
...
export function TitleBar({ state }: { state: MockupStateId }) {
  ...
  return (
    ...
    >
      <span className="truncate text-[13.5px] font-medium text-mock-fg">Padu homepage</span>
      <span className="truncate text-[12.5px] text-mock-fg-muted">padu</span>
