...
pub fn run() {
    ...
    gpui_platform::application()
        ...
        .run(move |cx: &mut App| {
            ...
            crate::app::init_delete_session_dialog_keys(cx);
            crate::app::init_goal_dialog_keys(cx);
            crate::app::init_host_dialog_keys(cx);
            ...
            cx.bind_keys([
                ...
                KeyBinding::new("secondary-j", ToggleRightPanelFullscreen, None),
                KeyBinding::new("secondary-alt-right", NextRightPanelTab, None),
                KeyBinding::new("secondary-alt-left", PrevRightPanelTab, None),
                KeyBinding::new("secondary-alt-b", OpenBrowser, None),
                KeyBinding::new("secondary-shift-w", OpenBrowser, None),
                KeyBinding::new("secondary-t", OpenTerminal, None),
                KeyBinding::new("secondary-shift-t", OpenTerminal, None),
                KeyBinding::new("secondary-shift-e", OpenFiles, None),
                KeyBinding::new("secondary-e", OpenFiles, None),
                KeyBinding::new("secondary-d", OpenReview, None),
                KeyBinding::new("secondary-shift-d", OpenReview, None),
                ...
                KeyBinding::new("secondary-alt-up", SelectPreviousSession, Some("Padu")),
                KeyBinding::new("secondary-alt-down", SelectNextSession, Some("Padu")),
                KeyBinding::new("secondary-shift-[", SelectPreviousSession, Some("Padu")),
                KeyBinding::new("secondary-shift-]", SelectNextSession, Some("Padu")),
    ...
    cx.set_menus(vec![
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    tr!("menu.toggle_right_panel_fullscreen"),
                    ToggleRightPanelFullscreen,
                ),
                MenuItem::action(tr!("menu.open_browser"), OpenBrowser),
                MenuItem::action(tr!("menu.open_terminal"), OpenTerminal),
                MenuItem::action(tr!("menu.open_files"), OpenFiles),
                MenuItem::action(tr!("menu.open_review"), OpenReview),
                ...
                MenuItem::separator(),
                MenuItem::action(tr!("menu.previous_session"), SelectPreviousSession),
                MenuItem::action(tr!("menu.next_session"), SelectNextSession),
            ],
        },
        Menu {
