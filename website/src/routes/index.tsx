...
const WINDOWS_DOCS_URL =
  'https://github.com/egoist/orbis/blob/main/docs/windows.md'
...
const FEATURES = [
  ...
  },
  {
    ...
    body: 'Projects, sessions, transcripts, and provider IDs live on your disk. No account, no telemetry, no Orbis cloud between you and your agents.',
  },
  {
    icon: RefreshCw,
...
const FAQ = [
  {
    ...
    a: 'No. Orbis is a single Rust binary rendered by GPUI, the UI framework Zed is built on. The window you see is drawn by the GPU, not by a browser engine.',
  },
  {
    q: 'Do I need new API keys?',
    a: 'No. Orbis detects amp, claude, codex, cursor-agent, opencode, grok, pi, and kimi on your machine and drives them directly — your existing logins, plans, and rate limits apply unchanged.',
  },
  {
    q: 'Where does my data live?',
    a: 'On your machine. Projects, sessions, transcripts, and provider session IDs are stored locally. There is no Orbis account and no telemetry.',
  },
  {
      ...
      <Menu.Portal>
        ...
        >
          <Menu.Popup className="min-w-52 origin-(--transform-origin) rounded-lg border bg-popover p-1 text-popover-foreground shadow-md outline-none data-[side=bottom]:slide-in-from-top-1 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95">
            ...
            <Menu.LinkItem
              href="https://github.com/egoist/orbis/blob/main/docs/linux.md"
              target="_blank"
              rel="noreferrer"
              closeOnClick
              className={itemClassName}
        ...
        <div className="mx-auto w-full max-w-[1100px] border-border/70 md:border-x">
          ...
          <header className="flex h-16 items-center justify-between px-5 md:px-10">
            ...
            <div className="flex items-center gap-5">
              <a
                href="https://github.com/egoist/orbis"
                target="_blank"
                rel="noreferrer"
                aria-label="GitHub"
          ...
          <main>
            ...
            <section className="px-5 pt-14 pb-14 md:px-10 md:pt-24">
              ...
              <p className="mt-5 max-w-[36rem] text-[17px] leading-relaxed text-pretty text-muted-foreground">
                Orbis drives the agent CLIs you already have — sessions,
            ...
            <section>
              <picture>
                ...
                <img
                  ...
                  alt="Orbis showing a coding-agent session"
                  width={2266}
                  height={1752}
