...
export const Route = createFileRoute("/docs/")({
  head: () => {
    ...
    if (!doc)
      return pageMeta(
        "Docs - Padu",
        "Install Padu and start running coding agents from your phone, desktop, and terminal.",
        "/docs",
      );
    return pageMeta(`${doc.frontmatter.title} - Padu Docs`, doc.frontmatter.description, "/docs");
  },
  component: DocsIndex,
});
