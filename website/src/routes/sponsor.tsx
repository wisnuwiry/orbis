...
export const Route = createFileRoute("/sponsor")({
  head: () =>
    pageMeta(
      "Sponsor Padu",
      "Support the independent open-source project behind Padu. Built by Mo, funded by the community.",
      "/sponsor",
    ),
  component: Sponsor,
});
  ...
  return (
    <SiteShell width="default">
      ...
      <div className="space-y-6 text-white/70 leading-relaxed max-w-2xl">
        ...
        <p>
          Padu started as a personal project: I wanted to run coding agents from anywhere without
          giving up control of my code, my keys, or my workflow.
        </p>

        <p>
          I work on Padu full-time. It&apos;s an independent, self-funded open-source project. I
      ...
      <section className="mt-12 space-y-4">
        <h2 className="text-xl font-medium">Support Padu</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <a
            href="https://opencollective.com/padu-ai/donate?interval=month&amount=10&contributeAs=me"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/[0.03] p-5 hover:border-white/20 hover:bg-white/[0.05] transition-colors"
          >
          ...
          <a
            href="https://buymeacoffee.com/padu"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/[0.03] p-5 hover:border-white/20 hover:bg-white/[0.05] transition-colors"
          >
