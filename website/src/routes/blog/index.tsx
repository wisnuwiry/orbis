...
export const Route = createFileRoute("/blog/")({
  ...
  head: () =>
    pageMeta(
      "Blog – Updates and announcements from the Padu team",
      "Product updates, technical posts, and announcements from the Padu team. Notes on building a fast, native multi-agent dev environment.",
      "/blog",
    ),
  component: BlogIndex,
});
