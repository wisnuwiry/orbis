...
export function AgentTranscript() {
  return (
    <div className="space-y-[13px] pt-[2px]">
      <Para>
        The homepage is built. It leads with Padu&rsquo;s actual value, then uses the product
      ...
      <div>
        ...
        <Bullet>Built desktop and mobile scenes from real Padu workflows and assets.</Bullet>
      ...
      <Para>PR opened: Rebuild the homepage around live Padu workflows.</Para>
      <span className="block text-[13.5px] text-mock-accent-bright">
        https://github.com/wisnuwiry/padu/pull/3981
      </span>
      <div>
...
const PLUGIN_TOOL_CALLS: PluginToolCall[] = [
  { kind: "read", label: "Read", detail: "padu-plugin/SKILL.md" },
  {
    kind: "shell",
    label: "Shell",
    detail: "padu plugin init ~/dev/release-radar",
  },
  {
    kind: "write",
    label: "Write",
  ...
  },
  {
    kind: "shell",
    label: "Shell",
    detail: "padu plugin install ~/dev/release-radar",
  },
];
...
export function PluginBuildTranscript() {
  return (
    <div className="space-y-[13px] pt-[2px]">
      <UserBubble>
        Build me a release radar for Padu. I want an explorer panel showing merged PRs, changes in
      ...
      <Para>
        The plugin API exposes Padu&rsquo;s live project and workspace state, so the radar
