...
const WORKING_ROWS: WorkspaceRow[] = [
  ...
  {
    id: "hub-worker",
    title: "Fix broken hub worker dev",
    avatar: { kind: "tile", letter: "P", tile: "bg-mock-tile-emerald" },
    time: "10m",
  },
  {
    id: "app-build-info",
    title: "Fix app build info in production build",
    avatar: { kind: "tile", letter: "P", tile: "bg-mock-tile-emerald" },
    time: "10m",
  },
  {
    id: "acp-auth",
    title: "Diagnose ACP auth loop on refresh",
    avatar: PADU,
    time: "24m",
    running: true,
  },
  {
    id: "multi-agent-sync",
    title: "Support multi-agent sync in live channels",
    avatar: { kind: "tile", letter: "S", tile: "bg-mock-tile-violet" },
    time: "1h",
  },
  {
    id: "diff-viewer-perf",
    title: "Audit virtualized diff viewer frames",
    avatar: { kind: "tile", letter: "T", tile: "bg-mock-tile-amber" },
    time: "1h",
  },
  {
    id: "beta",
  ...
  {
    id: "perf-cadence",
    title: "Optimize GPUI commit cadence under load",
    avatar: { kind: "tile", letter: "O", tile: "bg-mock-tile-sky" },
    time: "2h",
  },
  {
    id: "provider-harness",
    title: "Refactor provider driver harness",
    avatar: PADU,
    time: "3h",
  },
  {
    id: "worktree-fs",
    title: "Add worktree fs watcher support",
    avatar: PADU,
    time: "4h",
  },
  { id: "resume", title: "Resume in-progress work", avatar: PADU, time: "3d" },
  { id: "undef", title: "Undefined task", avatar: PADU, time: "3d" },
  { id: "codex-issue", title: "Diagnose cloud/Codex issue re…", avatar: PADU, time: "4d" },
  { id: "cws", title: "Diagnose create_workspace 37…", avatar: PADU, time: "4d" },
  { id: "taps", title: "Diagnose tap interactions", avatar: PADU, time: "4d" },
  { id: "clarify", title: "Clarify task requirements", avatar: PADU, time: "5d" },
  { id: "abc", title: "Task for abcdefghi", avatar: PADU, time: "5d" },
];
