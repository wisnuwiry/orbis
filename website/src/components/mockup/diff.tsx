...
export const PROVIDERS_HUNK_TAIL: DiffRow[] = [
  {
    kind: "line",
    n: "78",
    text: "OpenCode 1 keeps MCP and process environment outside the session boundary. Padu shares",
    mark: "add",
  },
  ...
  { kind: "line", n: "81", text: "" },
  {
    kind: "line",
    n: "82",
    text: "OpenCode owns user message IDs. Do not pass Padu-generated IDs to OpenCode prompt APIs",
  },
  { kind: "line", n: "83", text: "" },
];
