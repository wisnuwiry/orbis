...
AppPublisher=Padu
AppPublisherURL=https://padu.dev
AppSupportURL=https://github.com/wisnuwiry/padu/issues
AppUpdatesURL=https://github.com/wisnuwiry/padu/releases
DefaultDirName={autopf}\Padu
DefaultGroupName=Padu
UninstallDisplayName=Padu
UninstallDisplayIcon={app}\padu.exe
LicenseFile={#StageDir}\LICENSE
OutputDir={#OutputDir}
OutputBaseFilename=Padu-{#AppVersion}-{#Arch}-Setup
...
; Padu persists continuously to SQLite, so closing it is safe; a silent
; update cannot stop to ask, and a locked padu.exe would fail the install.
...
[Files]
Source: "{#StageDir}\padu.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#StageDir}\padu-daemon.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#StageDir}\LICENSE"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{group}\Padu"; Filename: "{app}\padu.exe"
Name: "{userdesktop}\Padu"; Filename: "{app}\padu.exe"; Tasks: desktopicon

[Tasks]
Name: "desktopicon"; Description: "{cm:CreateDesktopIcon}"; Flags: unchecked

[Run]
; No skipifsilent: this is also how the updater's silent run brings Padu back.
Filename: "{app}\padu.exe"; Description: "{cm:LaunchProgram,Padu}"; Flags: nowait postinstall
