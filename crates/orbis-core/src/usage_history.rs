...
//! `ccusage` do it, so usage covers turns driven outside Orbis too. Costs are
...
pub use orbis_protocol::usage_history::{
...
mod tests {
    ...
    fn claude_lines_parse_usage_and_dedupe_key() {
        ...
        assert_eq!(record.project, "/Users/me/dev/orbis");
    ...
    fn codex_lines_carry_model_forward_and_skip_duplicates() {
        ...
        let meta = r#"{"timestamp":"2026-08-06T16:31:19.166Z","type":"session_meta",
            "payload":{"id":"codex-session","cwd":"/Users/me/dev/orbis"}}"#
            .replace('\n', " ");
    ...
    fn aggregation_dedupes_across_files_and_prices_records() {
        ...
        let record = UsageRecord {
            ...
            project: "/Users/me/dev/orbis/crates/ui".to_owned(),
            totals: TokenTotals {
        ...
        let roots = [PathBuf::from("/Users/me/dev/orbis")];
        ...
        assert_eq!(project.path, "/Users/me/dev/orbis");
    ...
    fn rate_tables_parse_and_round_trip_through_the_disk_cache() {
        ...
        let dir = std::env::temp_dir().join(format!("orbis-usage-rates-{}", std::process::id()));
