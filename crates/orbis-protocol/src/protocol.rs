...
pub const DAEMON_TOKEN_ENV: &str = "ORBIS_DAEMON_TOKEN";
pub const DAEMON_ADDRESS_ENV: &str = "ORBIS_DAEMON_ADDRESS";
pub const APP_EXECUTABLE_ENV: &str = "ORBIS_APP_EXECUTABLE";
