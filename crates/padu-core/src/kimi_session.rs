...
//! empty answer and calls it a success. Reading the wire log is what lets Padu
...
/// permission dialogs just by opening Padu's Resume picker.
...
/// hash Padu cannot reproduce, so the session id is matched by scanning.
