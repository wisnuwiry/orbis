...
const CONTEXT_PREFIX: &str = "PADU_CURSOR_BRANCH_CONTEXT_V1 ";
const CONTEXT_GUIDANCE: &str = concat!(
    "\nPADU_CURSOR_BRANCH_INSTRUCTIONS_V1\n",
...
const PROMPT_PREFIX: &str = "PADU_CURSOR_CURRENT_PROMPT_V1 ";
...
/// first prompt is seeded with Padu's retained visible conversation.
...
mod tests {
    ...
    fn cursor_seed_envelope_is_length_delimited() {
        ...
        assert!(prompt.starts_with("PADU_CURSOR_BRANCH_CONTEXT_V1 17\n"));
        assert!(prompt.ends_with("PADU_CURSOR_CURRENT_PROMPT_V1 13\ncontinue 🚀"));
    }
}
