...
use orbis_protocol::model::{ProviderKind, ProviderModelOption, ReportedCommand};
...
/// Whether the composer submitted Orbis's global terminal-session picker.
...
/// which Orbis bridges to the provider's service-tier control. Checking the
