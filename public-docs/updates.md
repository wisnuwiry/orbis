---
title: Updates
description: How Padu releases work, the difference between stable and beta channels, and how to opt in to earlier updates.
nav: Updates
order: 5
...
Padu ships updates through two channels: **Stable** and **Beta**.
...
Padu follows [Semantic Versioning](https://semver.org) with prerelease tags.
...
There is no beta channel in the app stores right now — only stable builds are submitted. If you want early Android builds, download the APK from the [GitHub releases page](https://github.com/wisnuwiry/padu/releases).
